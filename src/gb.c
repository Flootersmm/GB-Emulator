...
const OPS ops[256] = {
    ...
    {"JP NZ, 0x%04X", 2, U16_OP, {.func_u16_op = nop}},         // 0xc2
    {"JP 0x%04X", 2, U16_OP, {.func_u16_op = jp_nn}},           // 0xc3
    {"CALL NZ, 0x%04X", 2, U16_OP, {.func_u16_op = nop}},       // 0xc4
    {"PUSH BC", 0, NO_OP, {.func_no_op = nop}},                 // 0xc5
    {"ADD A, 0x%02X", 1, U8_OP, {.func_u8_op = nop}},           // 0xc6
    {"RST 0x00", 0, NO_OP, {.func_no_op = nop}},                // 0xc7
    {"RET Z", 0, NO_OP, {.func_no_op = nop}},                   // 0xc8
    {"RET", 0, NO_OP, {.func_no_op = nop}},                     // 0xc9
    {"JP Z, 0x%04X", 2, U16_OP, {.func_u16_op = nop}},          // 0xca
    {"CB %02X", 1, U8_OP, {.func_u8_op = nop}},                 // 0xcb
    {"CALL Z, 0x%04X", 2, U16_OP, {.func_u16_op = nop}},        // 0xcc
    {"CALL 0x%04X", 2, U16_OP, {.func_u16_op = nop}},           // 0xcd
    {"ADC 0x%02X", 1, U8_OP, {.func_u8_op = nop}},              // 0xce
    {"RST 0x08", 0, NO_OP, {.func_no_op = nop}},                // 0xcf
    {"RET NC", 0, NO_OP, {.func_no_op = nop}},                  // 0xd0
    {"POP DE", 0, NO_OP, {.func_no_op = nop}},                  // 0xd1
    {"JP NC, 0x%04X", 2, U16_OP, {.func_u16_op = nop}},         // 0xd2
    {"UNKNOWN", 0, NO_OP, {.func_no_op = nop}},                 // 0xd3
    {"CALL NC, 0x%04X", 2, U16_OP, {.func_u16_op = nop}},       // 0xd4
    {"PUSH DE", 0, NO_OP, {.func_no_op = nop}},                 // 0xd5
    {"SUB 0x%02X", 1, U8_OP, {.func_u8_op = nop}},              // 0xd6
...
void write_u16(GB *vm, u16 addr, u16 value) {
  vm->mem.data[addr] = (u8)(value & 0x00FF);
  vm->mem.data[addr + 1] = (u8)((value >> 8) & 0x00FF);
}
