...
const OPS ops[256] = {
    ...
    {"INC HL", 0, NO_OP, {.func_no_op = inc_hl}},                   // 0x23
    ...
    {"DEC HL", 0, NO_OP, {.func_no_op = dec_hl}},                   // 0x2b
    ...
    {"SBC B", 1, U8_OP, {.func_u8_op = sbc_a_b}},                   // 0x98
    {"SBC C", 1, U8_OP, {.func_u8_op = sbc_a_c}},                   // 0x99
    {"SBC D", 1, U8_OP, {.func_u8_op = sbc_a_d}},                   // 0x9a
    {"SBC E", 1, U8_OP, {.func_u8_op = sbc_a_e}},                   // 0x9b
    {"SBC H", 1, U8_OP, {.func_u8_op = sbc_a_h}},                   // 0x9c
    {"SBC L", 1, U8_OP, {.func_u8_op = sbc_a_l}},                   // 0x9d
    {"SBC (HL)", 1, U8_OP, {.func_u8_op = sbc_a_hl}},               // 0x9e
    {"SBC A", 1, U8_OP, {.func_u8_op = sbc_a_a}},                   // 0x9f
    ...
    {"LD (0xFF00 + C), A", 1, U8_OP, {.func_u8_op = ld_0xffc_a}},   // 0xe2
    ...
    {"POP AF", 0, NO_OP, {.func_no_op = pop_af}},                   // 0xf1
    {"LD A, (0xFF00 + C)", 1, U8_OP, {.func_u8_op = ld_a_0xffc}},   // 0xf2
